...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rae_oyster\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rae_oyster\hook\ament_prefix_path.bat"
